    ...
    if title:
        ...
        if not err2 and bundle:
            ...
            if tfidf_cards:
                ...
                st.info("ℹ️ This movie is not present in the local database (which contains movies up to 2017), so content-based TF-IDF recommendations are unavailable. Showing genre-based recommendations below instead.")
